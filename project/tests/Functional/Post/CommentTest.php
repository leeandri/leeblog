...
class CommentTest extends WebTestCase
{
    public function testPostCommentWorks(): void
    {
        ...
        $form = $crawler->filter('form[name=comment]')->form([
            'comment[content]' => 'My test of how comments work.'
        ]);
        ...
        $this->assertSelectorTextContains('div.alert.alert-success', 'Your comment has been registered. It will be moderated as soon as possible.');
    }
    ...
    public function testDeleteCommentWorks(): void
    {
        ...
        $client->followRedirect();
        $this->assertSelectorTextContains('div.alert.alert-success', 'Your comment has been removed.');
    }
}
