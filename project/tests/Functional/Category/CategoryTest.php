...
class CategoryTest extends WebTestCase
{
    public function testCategoryPageWorks(): void
    {
        ...
        $client->request(Request::METHOD_GET, $urlGeneratorInterface->generate('category.index', ['slug' => $category->getSlug()]));

        $this->assertResponseIsSuccessful();
        $this->assertResponseStatusCodeSame(Response::HTTP_OK);

        $this->assertSelectorExists('h1');
        $this->assertSelectorTextContains('h1', 'Category : ' . ucfirst($category->getName()));
    }
    ...
    public function testPaginationWorks(): void
    {
        ...
        $crawler = $client->request(Request::METHOD_GET, $urlGeneratorInterface->generate('category.index', ['slug' => $category->getSlug()]));
